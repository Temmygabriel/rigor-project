  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 32 }}>
        ...
        {/* FIX (steward feedback, issue 3): honest about BOTH gates now, not
            just the round count -- a critique needs enough elapsed rounds
            AND enough distinct committing addresses since its own commit. */}
        <p className="micro muted" style={{ margin: "6px 0 16px" }}>
          ...
          {MIN_DISTINCT_COMMITTERS} distinct addresses have committed since then — the second
          check exists so one address can't rush its own window by spamming cheap commits.
        </p>
